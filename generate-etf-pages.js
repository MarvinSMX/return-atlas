...
/* ═══════════════════════════════════════════════════════════════
   PROMO SLOT
   House promo for YieldAtlasPRO.com. No paid display ads.
  ...
  return `<footer>
    <div class="container">
      <div class="footer-content">
        ...
        <p class="footer-copyright">© ${new Date().getFullYear()} ReturnAtlas. All rights reserved.</p>
      </div>
    </div>
  </footer>`;
}
...
function buildEtfPage(e, all) {
  ...
  const title = `${e.symbol} ETF Scorecard — Yield ${e.yieldRaw || 'N/A'}, Total Return ${e.totalRaw || 'N/A'} | ReturnAtlas`;
...
function buildIndexPage(all) {
  ...
  const title = 'All ETF Scorecards — Yield, Total Return & Grades | ReturnAtlas';
